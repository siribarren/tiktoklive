...
- `TIKTOK_SESSION_ID` y `TIKTOK_TT_TARGET_IDC` (opcionales): cookies de sesión para consultar `room_info` en lives restringidos y exponer URL de playback HLS al frontend.
